...
const metadata = {
  subsystemName: "service-graph",
  components: [
    {
      name: "node-finder",
      dashboard_name: "node-finder",
      container_name: "node-finder",
...
function getHealthStatus(iteratorAgeSummary) {
  ...
  const iteratorAgeThreshold =
    config.healthCheckthresholds.subsystems["service-graph"]
      .iteratorAgeSeconds * 1000;
